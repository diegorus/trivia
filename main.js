...
class InicioScene extends Phaser.Scene {
    ...
    create(){
        ...
        // Título del juego
        this.add.text(180,100,"TRIVIA DEL SWAG",{
            fontSize:"28px",
            color:"#964808"
...
class TriviaScene extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("fondoJuego","../img/fondo1.jpg");
    }
    ...
    create(){
        ...
        this.preguntas = [
            {pregunta:"¿Qué rapero lanzó el álbum To Pimp a Butterfly?", opciones:["Kanye west","Lil Uzi","Kendrick lamar","NWA"], correcta:2},
            {pregunta:"¿Qué rapero lanzó el álbum My Beautiful Dark Twisted Fantasy?", opciones:["Kanye west","Lil Uzi","Kendrick lamar","NWA"], correcta:0},
            {pregunta:"¿que canciones de la obsecion factory?", opciones:["YHLQMDLG","La quienta sinfonia","Chichabeba","tus zapatos"], correcta:2},
            {pregunta:"¿Qué rapero ganó el Premio Pulitzer de Música en 2018?", opciones:["RZA","Reakwon","Kendrick Lamar","Nas"], correcta:2},
            {pregunta:"¿Qué artista lanzó el álbum YHLQMDLG?", opciones:["Tainy","Plan B","Yeyo","Bad bunny"], correcta:3},
            {pregunta:"¿¿Qué dúo de productores creó los álbumes Mas Flow?", opciones:["Tainy","Luny Tunes","Ezya","J dilla"], correcta:1},
            {pregunta:"¿Qué album es de Dr Dre?", opciones:["The Chronic","wu tang forever","MUSIC","The carter IV"], correcta:0},
            {pregunta:"¿quien es mas malo?", opciones:["yeyo","YE","young thug","Playboi carti"], correcta:0},
        ];  
...
class FinalScene extends Phaser.Scene {
    ...
    create(){
        this.cameras.main.setBackgroundColor("#bb3c3c");
